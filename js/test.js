...
$('.supportingImgs').append(
  '<img src="'
  + thisCar.supportImg1 + '" alt="' + thisCar.car + ' Image 1" class="' + thisCar.car + 'Sup"/><img src="'
  + thisCar.supportImg2 + '" alt="' + thisCar.car + ' Image 2" class="' + thisCar.car + 'Sup" /><img src="'
  + thisCar.supportImg3 + '" alt="' + thisCar.car + ' Image 3" class="' + thisCar.car + 'Sup" /><img src="'
  + thisCar.supportImg4 + '" alt="' + thisCar.car + ' Image 4" class="' + thisCar.car + 'Sup" /><img src="'
  + thisCar.supportImg5 + '" alt="' + thisCar.car + ' Image 5" class="' + thisCar.car + 'Sup" /><img src="'
  + thisCar.supportImg6 + '" alt="' + thisCar.car + ' Image 6" class="' + thisCar.car + 'Sup" /><img src="'
  + thisCar.supportImg7 + '" alt="' + thisCar.car + ' Image 7" class="' + thisCar.car + 'Sup" /><img src="'
  + thisCar.supportImg8 + '" alt="' + thisCar.car + ' Image 8" class="' + thisCar.car + 'Sup" /><img src="'
  + thisCar.supportImg9 + '" alt="' + thisCar.car + ' Image 9" class="' + thisCar.car + 'Sup" /><img src="'
  + thisCar.supportImg10 + '" alt="' + thisCar.car + ' Image 10" class="' + thisCar.car + 'Sup" /><img src="'
  + thisCar.supportImg11 + '" alt="' + thisCar.car + ' Image 11" class="' + thisCar.car + 'Sup" /><img src="'
  + thisCar.supportImg12 + '" alt="' + thisCar.car + ' Image 12" class="' + thisCar.car + 'Sup" /><img src="'
  + thisCar.supportImg13 + '" alt="' + thisCar.car + ' Image 13" class="' + thisCar.car + 'Sup" /><img src="'
  + thisCar.supportImg14 + '" alt="' + thisCar.car + ' Image 14" class="' + thisCar.car + 'Sup" /><img src="'
  + thisCar.supportImg15 + '" alt="' + thisCar.car + ' Image 15" class="' + thisCar.car + 'Sup" /><img src="'
  + thisCar.supportImg16 + '" alt="' + thisCar.car + ' Image 16" class="' + thisCar.car + 'Sup" /><img src="'
  + thisCar.supportImg17 + '" alt="' + thisCar.car + ' Image 17" class="' + thisCar.car + 'Sup" /><img src="'
  + thisCar.supportImg18 + '" alt="' + thisCar.car + ' Image 18" class="' + thisCar.car + 'Sup" /><img src="'
  + thisCar.supportImg19 + '" alt="' + thisCar.car + ' Image 19" class="' + thisCar.car + 'Sup" /><img src="'
  + thisCar.supportImg20 + '" alt="' + thisCar.car + ' Image 20" class="' + thisCar.car + 'Sup" /><img src="'
  + thisCar.supportImg21 + '" alt="' + thisCar.car + ' Image 21" class="' + thisCar.car + 'Sup" /><img src="'
  + thisCar.supportImg22 + '" alt="' + thisCar.car + ' Image 22" class="' + thisCar.car + 'Sup" /><img src="'
  + thisCar.supportImg23 + '" alt="' + thisCar.car + ' Image 23" class="' + thisCar.car + 'Sup" /><img src="'
  + thisCar.supportImg24 + '" alt="' + thisCar.car + ' Image 24" class="' + thisCar.car + 'Sup" /><img src="'
  + thisCar.supportImg25 + '" alt="' + thisCar.car + ' Image 25" class="' + thisCar.car + 'Sup" /><img src="'
  + thisCar.supportImg26 + '" alt="' + thisCar.car + ' Image 26" class="' + thisCar.car + 'Sup" /><img src="'
  + thisCar.supportImg27 + '" alt="' + thisCar.car + ' Image 27" class="' + thisCar.car + 'Sup" /><img src="'
  + thisCar.supportImg28 + '" alt="' + thisCar.car + ' Image 28" class="' + thisCar.car + 'Sup" /><img src="'
  + thisCar.supportImg29 + '" alt="' + thisCar.car + ' Image 29" class="' + thisCar.car + 'Sup" /><img src="'
  + thisCar.supportImg30 + '" alt="' + thisCar.car + ' Image 30" class="' + thisCar.car + 'Sup" /><img src="'
  + thisCar.supportImg31 + '" alt="' + thisCar.car + ' Image 31" class="' + thisCar.car + 'Sup" /><img src="'
  + thisCar.supportImg32 + '" alt="' + thisCar.car + ' Image 32" class="' + thisCar.car + 'Sup" /><img src="'
  + thisCar.supportImg33 + '" alt="' + thisCar.car + ' Image 33" class="' + thisCar.car + 'Sup" />');


  $('.mainImg').append(
    '<img src="' + thisCar.supportImg2 + '" alt="' + thisCar.car + ' Image" />'
  );
